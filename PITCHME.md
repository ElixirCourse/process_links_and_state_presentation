...
* Ако някой от свързаниет процеци излезе без грешка - другите не 'умират'.
...
* Собщението има статус :killed.

#HSLIDE
* Статусът от :kill стана :killed.
* Процесът който изпрати :kill беше свързан с този, който беше 'убит', и не искаме сигналът да рекушира обратно.
